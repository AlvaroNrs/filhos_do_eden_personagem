...
class HomePage extends StatelessWidget {
  ...
  const HomePage({super.key, required this.dataViewModel, required this.updateIndex, required this.updateStep,
          ...
          child: Column(
            ...
            children: [
              CircularMainButton(text: "Novo Personagem", onPressed: (){ 
                dataViewModel.resetGeneratedCharacter(); resetOptions(); updateStep(0); updateIndex(3);
              },
